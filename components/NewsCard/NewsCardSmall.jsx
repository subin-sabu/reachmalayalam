// components/NewsCard/NewsCardSmall.jsx
...
function NewsCardVertical({ startIndex, endIndex, heading, className, category, cardLimit, negativeTags, omitLimit, data = [], noTime }) {
  ...
  return (
    <Box className={className} mt={2} mb={2}>
      {heading && (
        <Typography gutterBottom variant="h2" color="primary.sub" sx={{ display: 'flex', alignItems: 'center', gap: '0.7rem', fontSize: '1.3rem', fontWeight: 600, }}>
