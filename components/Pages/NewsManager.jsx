  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-evenly', paddingBottom: '1rem', paddingTop: '1rem', marginBottom: '1rem', backgroundColor: '#F8F8F8' }}>
        ...
        <Button onClick={() => navigate('/admin/add-news')} variant="contained" color="primary">
          Add News
        </Button>
              ...
              {newsList.map((news, index) => (
                <TableRow key={news.id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                  ...
                  {!mobileView && (
                    <>
                      <TableCell>
                        <Button onClick={() => navigate(`/admin/news-manager/edit-news/${news.id}`)} style={{ color: 'green' }}>
                          Edit
                        </Button>
                      </TableCell>
                      <TableCell>
                  ...
                  {mobileView && (
                    <TableCell>
                      ...
                      >
                        <MenuItem onClick={() => navigate(`/admin/news-manager/edit-news/${news.id}`)} style={{ color: 'green' }}>Edit</MenuItem>
